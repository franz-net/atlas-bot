...
MIN_CONVICTION_SCORE = 7          # Minimum AI self-rated conviction (1-10) to enter a trade

# ==================== RSI Direction Gate ====================
# Code-enforced RSI thresholds by trade direction (AI ignores prompt guidance)

LONG_MIN_RSI = 55                 # LONG requires RSI >= 55 (bullish momentum) OR <= 35 (oversold reversal)
LONG_REVERSAL_MAX_RSI = 35        # Oversold reversal ceiling
SHORT_MAX_RSI = 45                # SHORT requires RSI <= 45 (bearish momentum)
